...
class model_IA :
    ...
    def entrainement_test(self) :
        ...
        return self.model_pip, self.x_train, self.x_test, self.y_train, self.y_test, self.y_pred, self.score, self.confusion_matrix, self.N, self.train_score, self.val_score
